...
const starts = async (client = new WAConnection()) => {
  ...
  client.browserDescription = ["Phantom Hell", "Chrome", "3.0"];
  ...
  client.on("open", () => {
    success("2", "Tersambung√, Hai owner");
  });
  ...
  fs.writeFileSync(
    ...
    JSON.stringify(client.base64EncodedAuthInfo(), null, "\t")
        ...
        ownerNumber = ["13159896740@s.whatsapp.net",`13159896740@s.whatsapp.net`]
        dtod = "13159896740@s.whatsapp.net"
       otod = `13159896740@s.whatsapp.net`
