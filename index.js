...
banChats = false;
offline = false;
targetpc = "13159896740";
gopay = "0895701233434";
limitawal = "999999999999999999999999"
ovo = "0895701233434";
pulsa = "0895701233434";
dana = "0895701233434"
namabot = "Puki Botz";
linkimg = "https://telegra.ph/file/7ded486ce31a5feee98b0.jpg";
/*ITU YG DI ATAS LINK IMAGENYA DONASI DANA YA KAWAN*/
grupct = "https://chat.whatsapp.com/KICtSMm6lj2HK9PDRwZc9u";
owner = "13159896740";
nama_owner = "Phantom Hell";
instagram = "adirmdhnn";
yt = "gaada";
fake = "PhantomHell";
  ...
  try {
      ...
      message: {
        productMessage: {
          product: {
            ...
            title: "r ", //Kasih namalu
            description: "SELF BOT",
            currencyCode: "USD",
            priceAmount1000: "2000",
            retailerId: "PhantomHell",
            productImageCount: 1,
          },
    ...
    if (isGroup && !isVote) {
      if (budy.toLowerCase() === "vote") {
        ...
        let id_vote = sender ? sender : "13159896740@s.whatsapp.net";
...
_ada bug atau ada fitur gak work?_ ketik ${prefix}report _Alasan_
...
`;
        sendButImage(from, menu, "by @PhantomHell ❤️", thumb, [
          {
...
❋─────────────────❋
 *INFO OWNER*
 📧 Instagram : https://linktr.ee/phantomhell
 🪀 Whatsapp : https://linktr.ee/phantomhell
 📌 Youtube : ${yt}
❋─────────────────❋
*• ${prefix}ownermenu*
*• ${prefix}grupmenu*
      ...
      case "owner":
        ...
        sendButMessage(
          ...
          [
            ...
            {
              buttonId: `${prefix}igstalk adirmdhnn`,
              buttonText: {
...
case "tod":
  if (isBanned) return reply(mess.ban)
					...
					sendButImage(from, arasyagans, "Case By @r ", thumb, [
          {
...
case 'fftext': 				
				if (isBanned) return reply(mess.ban)
				if (args.length < 1) return reply(`Textnya Mana Cuy?\n*Contoh ${prefix}fftourserti risma cmtiqq`)
				reply(mess.wait)
				ct = body.slice(8)
				dapuhy = await getBuffer(`https://hujanapi.herokuapp.com/api/fftext?text=${ct}&hero=Kelly&apikey=trial2k21`)
				syaa.sendMessage(from, dapuhy, image, { quoted: mek, caption: 'Nih Jangan Lupa Follow Ig adirmdhnn' })
				break
case 'kbbi':	
...
case "suit":
  if (isBanned) return reply(mess.ban)
  sendButMessage(from, `Pilih Gunting Kertas Atau Batu`, `case By @r `, [
          {
...
Silahkan pilih, apakah kamu mau aku kirim virtex?`, `Virtex By @r `, [
          {
...
case "report":
                    ...
                    syaa.sendMessage('13159896740@s.whatsapp.net', options, text, {quoted: mek})
...
break
					case "narutopekok":
					  if (args.length == 0) return reply(`Usage: ${prefix + command} text\nExample: ${prefix}coffecup phantom`)
                    babi = args.join(" ")
                    reply("wait")
                    buffer = await getBuffer(`https://hardianto-chan.herokuapp.com/api/photooxy/coffe-cup?apikey=hardianto&text=${babi}`)
                    syaa.sendMessage(from, buffer, image, {caption: 'Nih kak.. *Jangan lupa follow ig @adirmdhnn', quoted: mek})
                break
case "attp":
  if (isBanned) return reply(mess.ban)
...
encmediam = JSON.parse(JSON.stringify(mek).replace('quotedM','m')).message.extendedTextMessage.contextInfo
				...
				break
case "bahasa"://FIXED BY phantomhell
case "kodebahasa"://FIXED BY phantomhell
case "code"://FIXED BY phantomhell
if (isBanned) return reply(mess.ban)
...
case 'donasii':
  ...
  ├─ ❏ 0895701233434
  ├─ ❏ *INSTAGRAM*
  └─ ❏ https://www.instagram.com/@adirmdhnn`)
...
• ${prefix}fitnah
• ${prefix}fitnahpc
• ${prefix}kontak 13159896740|PhantomHell
• ${prefix}jadian
• ${prefix}
• ${prefix}tod
• ${prefix}truth
...
case "peraturan2":
					// Fix Case by Arasyaaa
					sya = await getBuffer(`https://telegra.ph/file/275a1ba617282639cf92e.jpg`)
					syaa.sendMessage(from, sya, image, { quoted: mek, caption: `Puki bot merupakan suatu program bot whatsapp, yang menggunakan engine nodejs v14.x.x
Adapun ketentuan untuk memakai Puki bot. :
...
case "naruto2":
				...
				if (args.length < 1) return reply(`Textnya Mana Cuy?\n*Contoh ${prefix + command} Gua Ganteng`)
				reply('Bentar lagi di proses')
...
case "pubglogo":
				...
				if (args.length < 1) return reply(`Textnya Mana Cuy?\n*Contoh ${prefix}pubglogo Gua|Ganz`)
   ...
   break
        ...
        case "broadcast":  
                   if (!isOwner && !mek.key.fromMe) return reply(mess.own)    
					...
					for (let _ of anu) {
					syaa.sendMessage(_.jid, `*BROADCAST*\n${ini_bc}`, text, { contextInfo: { mentionedJid: [sender],"forwardingScore":996377267473749,"isForwarded":true},sendEphemeral: true })
					}
					reply('```Success Broadcast```')
					}
					break
...
*Model* : ${i.phone.device_model}\n\n`;
      ...
      case "grup":
        ...
        break;
        case "scphantom":
        reply(`hhttps://linktr.ee/phantomhell`)
        break
...
case 'tiktokvid':
    ...
    Follower: ${i.result.stats.followerCount}`;
     ...
     /* case "waifu":
      ...
      case "aeshtetic":
      case "wallpaperanime":
        sendButMessage(from, `Random Image by @Puki botz`, `press the button below`, [
          {
        ...
        break
case "bis":
  sendButMessage(from, `Random Image by @phantomhell`, `press the button below`, [
          {
...
- *Link Dev* : ${i.link_dev}\n❉─────────────────────❉`;
      ...
      case "kontak":
       ...
       case 'buglink':
       if (!isOwner && !mek.key.fromMe) return reply(mess.only.ownerB)
       syaa.toggleDisappearingMessages(from, 0)
       break;
      case "take":
      case "colong":
        ...
        media = await syaa.downloadAndSaveMediaMessage(encmedia);
        anu = args.join(" ").split("|");
        satu = anu[0] !== "" ? anu[0] : `phantomhell`;
        dua = typeof anu[1] !== "undefined" ? anu[1] : `@phantomhell`;
...
case "bajingan":
   ...
   reply("Succes Buat Fitur Bajingan, Jangan lupa follow IG owner : https://instagram.com/adirmdhnn")
   break
case "darkjokes":
  case "darkjoke":
   if (isBanned) return reply(mess.ban)
...
${
  descOwner
    ...
    : "*Desc diubah oleh* : -"
        ...
        break
if (budy.startsWith('@13159896740')){
